import { Box, Heading, Text, Center, Stack, Divider } from '@chakra-ui/react';
...
const Headline = () => {
  ...
  return (
    <Box ref={ref} as="section" bg="white" py={20} px={10} borderBottom= "2px solid black">
      <Center>
        <MotionStack 
          spacing={6}
          alignItems="center"
        ...
        >
          ...
          <MotionText
            ...
            animate={inView ? 'visible' : 'hidden'}
          >
            Finetune European housemade foundation models customized for your business needs.
          </MotionText>
        </MotionStack>
      </Center>
    </Box >
